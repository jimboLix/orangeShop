...
<div class="bar">
    <div class="bar_w">
        ...
        <ul class="r uls">
            ...
            <c:if test="${sessionScope.get('buyer_session') == null}"><li class="dev"><a href="javascript:void(0)" onclick="login()">[登陆]</a></li></c:if>
            ...
            <li class="dev"><a href="javascript:void(0)" onclick="shopcar()" title="购物车">购物车</a></li>
...
<div class="w loc">
    <div class="h-title">
        <div class="h-logo"><a href="http://localhost:8080"></a></div>
        <div class="h-search">
            <input type="text"/>
...
<div class="w ofc mt">
    <div class="l">
        <div class="showPro">
            <div class="big"><a id="showImg" class="cloud-zoom" href="${product.img.allUrl }"
                                rel="adjustX:10,adjustY:-1"><img alt="" src="${allUrl }"></a></div>
        </div>
    </div>
    <div class="r" style="width: 640px">
        <ul class="uls form">
                ...
                <div id="colors" class="pre spec">
                    <c:forEach items="${colors }" var="color">
                        <a onclick="colorToRed(this,${color.id})" href="javascript:void(0)" title="${color.name }"
                           class="changToWhite"><img width="25" height="25" data-img="1" src="${allUrl}"
            ...
            <li class="submit"><input type="button" value="" class="hand btn138x40b"
        ...
        <div class="box bg_white">
            <ul class="uls x_50x50">
                <li>
                    ...
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="${base}/images/ppp.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
