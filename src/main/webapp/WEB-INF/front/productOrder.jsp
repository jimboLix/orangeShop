...
<form action="${base}/buyer/confirmOrder.shtml" method="post">
    ...
    <div class="w ofc case">
        ...
        <div class="box bg_white">
            <dl class="distr">
                <dd>${buyer.username }  <span style="margin-left: 30px">${buyer.addr }</span></dd>
            </dl>
        </div>
            ...
            <table cellspacing="0" class="tab tab4" summary="">
                ...
                <c:forEach items="${buyCart.items }" var="item">
                    <tr>
                        ...
                        <td class="img48x20">
                            <span class="inb"><img src="${item.sku.skuImg}"></span>
                            <a target="block"
                               href="javascript:void(0);">${fn:substring(item.sku.product.name,0,30) }--${item.sku.color.name }--${item.sku.size }</a>
                        </td>
